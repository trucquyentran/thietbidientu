                                    ...
                                    <ul class="plugin-action-buttons">
                                        ...
                                        <li>
                                            <a href="<?php echo esc_url( $details_link ); ?>"
                                               ...
                                               title="<?php echo esc_attr( $plugin_info['name'] ); ?>">
