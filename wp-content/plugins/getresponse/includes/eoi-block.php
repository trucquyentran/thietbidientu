...
function fca_eoi_gutenblock() {
	...
	if ( function_exists( 'register_block_type' ) ) {
		register_block_type( 'optin-cat/gutenblock',
			array(
				'editor_script' => 'fca_eoi_gutenblock_script',
...
function fca_eoi_gutenblock_enqueue() {
	...
	wp_localize_script( 'fca_eoi_gutenblock_script', 'fca_eoi_gutenblock_script_data', array( 'optins' => $table_list, 'twostep_optins' => $table_twostep_list, 'editurl' => admin_url( 'post.php' ), 'newurl' => admin_url( 'post-new.php' )  ) );
...
function fca_eoi_gutenblock_render( $attributes ) {
	...
	return '<p>' . __( 'Click here and select an optin form from the menu above.', 'easy-opt-ins' ) . '</p>';
}
...
function fca_eoi_gutenblock_twostep_render( $attributes ) {
	...
	return '<p>' . __( 'Click here and select a two-step optin form from the menu above.', 'easy-opt-ins' ) . '</p>';
}