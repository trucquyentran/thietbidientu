...
return array(
   ...
   'smart_button_hide_line_item' => array(
	...
	'paypal_logging'                     => array(
        ...
        'description' => sprintf(__('%1$sLog File%2$s: %3$s ( %4$s ) ', 'express-checkout-paypal-payment-gateway-for-woocommerce'), '<span style="color:green">', '</span>', strstr(wc_get_log_file_path('eh_paypal_express_log'), 'eh_paypal_express_log'), (file_exists(wc_get_log_file_path('eh_paypal_express_log')) ? $this->file_size(filesize(wc_get_log_file_path('eh_paypal_express_log'))):'' ) ),
