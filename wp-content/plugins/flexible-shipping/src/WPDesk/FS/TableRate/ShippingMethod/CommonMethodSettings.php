				...
				if ( ! defined( 'FLEXIBLE_SHIPPING_PRO_VERSION' ) ) {
					...
					$settings[ self::METHOD_FREE_SHIPPING_REQUIRES_UPSELLING ] = [
						...
						'options'     => [
							...
							'item_quantity'           => __( 'Minimum item quantity', 'flexible-shipping' ),
							'coupon'                  => __( 'Free shipping coupon', 'flexible-shipping' ),
							'order_amount_or_coupon'  => __( 'Free shipping coupon or minimum order amount', 'flexible-shipping' ),
							'order_amount_and_coupon' => __( 'Free shipping coupon and minimum order amount', 'flexible-shipping' ),
						],
						'description' => sprintf(
							// Translators: link.
