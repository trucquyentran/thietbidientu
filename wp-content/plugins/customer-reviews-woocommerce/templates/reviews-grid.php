...
?>
<div class="ivole-reviews-grid" id="<?php echo $id; ?>" style="<?php echo esc_attr( $section_style ); ?>" data-attributes="<?php echo wc_esc_json(wp_json_encode($attributes));?>">
	<?php
	...
	<?php if ( $show_more ): ?>
		<div class="cr-show-more">
			<button id="cr-show-more-reviews-grid" class="cr-show-more-button" type="button"><?php echo __( 'Show more', 'customer-reviews-woocommerce' ); ?></button>
